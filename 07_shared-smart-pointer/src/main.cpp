...
int main(int argc, char *argv[]) {
    ...
    // vehicle_ was moved to controller_ , after that the unique_prt was destroyed.
    // The following addres is NULL or zero.
    ...
    std::cout << "Acceleration: " <<vehicle_shared_->GetAcceleration() << std::endl;
    std::cout << "vehicle_shared_ memory:" << vehicle_shared_.get() << std::endl;
    // Create Controller Pointer
    // std::unique_ptr<Controller> controller_ = std::make_unique<Controller>();
    // Run controller using vehicle_ pointer information
    std::cout << "##Controller##" << std::endl;
